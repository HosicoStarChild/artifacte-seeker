      ...
      <div className="bg-dark-800 rounded-lg overflow-hidden border border-white/5 h-full">
        <div className="relative h-52 overflow-hidden">
          ...
          <div className="absolute top-3 left-3 flex items-center gap-2">
            ...
            <span className="bg-dark-900/80 text-white text-[10px] font-mono px-2 py-0.5 rounded">
              <Countdown endTime={auction.end_time} />
            </span>
          </div>
        </div>
        <div className="p-4">
          <p className="text-gold-500 text-[10px] font-bold tracking-wider mb-1">{auction.subtitle}</p>
